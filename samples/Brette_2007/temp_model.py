...
add_monitors_to_all_networks(locals())
print "Simulation running..."
default_magic_network = MagicNetwork(verbose=False, level=2)
add_monitors_to_all_networks(locals())
default_magic_network.run(1*msecond)
start_time=time.time()

default_magic_network = MagicNetwork(verbose=False, level=2)
add_monitors_to_all_networks(locals())
default_magic_network.run(200*msecond)
